...
-   Vanaf het moment dat je hiervoor **toestemming** verleent, verzamelen we **Locatiegegevens**, zoals GPS-gegevens. 
-   Zodra je in de App **akkoord bent gegaan met de Gebruiksvoorwaarden**, krijgen we je **Gebruiksgegevens**. Dit zijn gegevens over de handelingen die je als gebruiker uitvoert binnen de App, zoals het openen en het sluiten van de App. 
...
-   Om de **basisfunctionaliteiten** van de App te testen.
-   Om aan te tonen op welke manieren de App kan **bijdragen aan het genereren van nauwkeurige en actuele Persoonsgegevens voor wetenschappelijk onderbouwd beleid in tijden van crisis** en potentieel het **verlichten van de gezondheidszorg.**
...
-   Alleen de **geaggregeerde resultaten** van de test kunnen beschikbaar worden gesteld aan de **relevante beleidsadviseurs en experten**.
...
-   Je kunt ons op elk moment vragen om je Persoonsgegevens in te kijken, te corrigeren of te verwijderen. Stuur ons een e-mail naar <coveredapp@ugent.be>. Meer informatie vind je in Artikel 6 van het volledige Privacybeleid. 

## Wat doen we om jouw Persoonsgegevens te beschermen?

-   We hebben in de App allerlei veiligheidsmaatregelen geïncorporeerd op technisch en organisatorisch niveau.
...
-   Je Persoonsgegevens zijn enkel gelinkt aan je unieke deviceID, waardoor je Persoonsgegevens gepseudonimiseerd zijn.
-   Daarnaast worden je Persoonsgegevens geëncrypteerd opgeslagen en regelmatig geback-upt.
-   Je Persoonsgegevens worden nier langer dan 3 maanden, de testperiode van de App, bewaard.
...
Persoonsgegevens uit de App zullen enkel opgeslagen worden in functie van (1) het testen van de App; (2) het genereren van nauwkeurige en actuele Persoonsgegevens voor wetenschappelijk onderbouwde beleidskeuzes in tijden van crisis en (3) het verlichten van de gezondheidszorg. 

### 1\. Welke Persoonsgegevens verzamelen we?

Als Gebruiker verzamelen en verwerken we volgende Persoonsgegevens:

-   Locatiegegevens: je GPS gegevens.
...
-   Functionele gegevens: je type toestel, de taalinstelling van het bestuurssysteem van je toestel (bv. Be-Nl of Be-Fr), de store waarin je de App gedownload en geïnstalleerd hebt, samen met de versienaam (Android) en de bundel (iOS), de tijd (in milliseconden) wanneer je de App eerst opende en de gebruiksduur van de App, afgerond tot het eerstvolgende uur, het land waar je verblijft en je locatiegegevens (via GSP), nabijheid van andere Gebruikers van de App (via GPS gegevens).

Wanneer worden deze Persoonsgegevens verzameld?

-   Locatiegegevens: vanaf het moment dat je hiervoor je toestemming gegeven hebt tot het moment waarop je toestemming intrekt, je de App verwijdert of de testperiode van de App is afgelopen. 
-   Gebruiksgegevens: vanaf het moment dat je in de App akkoord bent gegaan met de Gebruiksvoorwaarden en dit privacybeleid tot het moment waarop je toestemming intrekt, je de App verwijdert of de testperiode van de App is afgelopen. 
-   Functionele gegevens: vanaf het moment dat je de App gedownload hebt tot het moment waarop je de App verwijdert of de testperiode van de App is afgelopen.
...
De huidige versie van de App is een beperkte versie die tot doel heeft de basisfunctionaliteiten te testen en aan te tonen op welke manieren de App kan bijdragen aan het genereren van nauwkeurige en actuele Persoonsgegevens voor wetenschappelijk onderbouwd beleid in tijden van crisis en potentieel het verlichten van de gezondheidszorg. 

Om dit te bereiken heeft de App de hierboven opgesomde Persoonsgegevens van de Gebruikers nodig. Deze Locatiegegevens en Gebruiksgegevens zullen enkel worden verwerkt op basis van de **uitdrukkelijke toestemming** van de Gebruikers. Deze toestemming wordt gegeven doordat de Gebruiker zich akkoord verklaart met deze privacyverklaring. 

De functionele gegevens worden verwerkt in het kader van het gerechtvaardigd belang van de UGent. 

Het uiteindelijke doel van de App is om potentiële besmette en niet besmette clusters (groep van personen), hotspots en super verspreiding (blootstelling aan vele Gebruikers) in kaart te brengen om zo het Coronavirus te kunnen indijken. 
...
Door je gebruik van de App worden er Locatiegegevens, Gebruiksgegevens en Functionele Persoonsgegevens verzameld. De App creëert een unieke deviceID voor je toestel, waardoor we je toestel als Gebruiker herkennen. Jouw Persoonsgegevens worden enkel gelinkt aan deze deviceID, waardoor er geen andere Persoonsgegevens van jou, zoals je naam, geboortedatum, adres of leeftijd nodig zijn. Bijgevolg kunnen je Persoonsgegevens enkel aan je toestel gelinkt worden, niet aan je naam. 

Om je Gegevens te beschermen tegen onrechtmatige toegang worden volgende technieken gebruikt:

-   De opslag op je toestel is geëncrypteerd.
-   Het transport verloopt geëncrypteerd.
-   De opslag bij Google Cloud Platform is geëncrypteerd.
...
-   *Relevante beleidsadviseurs en experten*: deze krijgen geen toegang tot je Persoonsgegevens. Wel zullen de geaggregeerde resultaten van deze test met hen gedeeld worden in functie van de doeleinden van de App. Voorbeelden hiervan zijn grafieken en tendensen. 
...
Al je Persoonsgegevens in de App worden lokaal op je toestel en tijdens de uitwisseling van je toestel naar de Google Cloud geëncrypteerd. Bovendien zijn je Persoonsgegevens enkel gelinkt aan je unieke deviceID, waardoor je Persoonsgegevens gepseudonimiseerd zijn. 
...
Uitoefening van je rechten: Je kunt je rechten uitoefenen door ons daartoe te contacteren, hetzij per e-mail naar <E-MAIL> of per post naar Universiteit Gent, St. Pietersnieuwstraat 33, 9000 Gent, mits toevoeging kopie identiteitskaart.
...
Het uitoefenen van je rechten kan via een eenvoudig verzoek per e-mail aan coveredapp@ugent.be, waarbij we jouw aanvraag binnen een termijn van zeven dagen trachten te verwerken. Dit uitgezonderd de Persoonsgegevens die door de arts tijdens de diagnose verzameld worden, deze worden niet bewaard of verwerkt in de App.
...
Voor verdere vragen over de verschillende rechten en plichten op het gebied van privacy, of indien je meent dat je Persoonsgegevens onterecht en/of onjuist worden verwerkt door de UGent, kan je terecht bij de Functionaris Gegevensbescherming (Data Protection Officer) van de UGent via privacy@ugent.be.
